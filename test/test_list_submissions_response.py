...
class TestListSubmissionsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListSubmissionsResponse:
        """Test ListSubmissionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListSubmissionsResponse`
        """
        model = ListSubmissionsResponse()
        if include_optional:
            return ListSubmissionsResponse(
                submissions = [
                    docspring.models.submission.submission(
                        batch_id = '', 
                        data_requests = [
